...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modules__WEBPACK_IMPORTED_MODULE_1__["default"])(modalState);
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#width'); //вызов функции для проверки на числа

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height'); //вызов функции для проверки на числа
...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (item) {
    item.addEventListener('input', function () {
      item.value = item.value.replace(/\D/, ''); //D - ищем все не цифры
    });
  });
};
 ...
 * Created by пк on 27.11.2020.
 */
//headerSelector - обворочивает табы
//tabSelector - каждый таб
// contentSelector - контент который показываем
